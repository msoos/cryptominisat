...
class VarReplacer
{
    public:
        ...
        template<class T>
        const bool replace(T& ps, const bool xorEqualFalse, const uint32_t group, const bool needToAddAsBin, const bool addBinAsLearnt = false);
    ...
    private:
        ...
        template <class T>
        void addBinaryXorClause(T& ps, const bool xorEqualFalse, const uint32_t group, const bool addBinAsLearnt = false);
