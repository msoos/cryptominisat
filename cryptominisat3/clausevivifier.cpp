...
bool ClauseVivifier::vivify_long_irred_cls()
{
    ...
    //Time-limiting
    uint64_t maxNumProps = 40LL*1000LL*1000LL;
...
void ClauseVivifier::str_and_sub_using_watch(
    Clause& cl
    , const Lit lit
...
void ClauseVivifier::Stats::printShort() const
{
...
void ClauseVivifier::Stats::print(const size_t nVars) const
{
    //Asymm
