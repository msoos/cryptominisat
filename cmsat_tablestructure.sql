...
CREATE TABLE `reduceDB` (
  ...
  `preRemovedResolBin` bigint(20) unsigned NOT NULL,
  `preRemovedResolTri` bigint(20) unsigned NOT NULL,
  `preRemovedResolLIrred` bigint(20) unsigned NOT NULL,
  `preRemovedResolLRed` bigint(20) unsigned NOT NULL,
  ...
  `preRemovedUsedUIP` bigint(20) unsigned NOT NULL,
