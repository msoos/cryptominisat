...
void PropEngine::attachTriClause(
    ...
    assert(varData[lit1.var()].removed == Elimed::none
            || varData[lit1.var()].removed == Elimed::queued_replacer);
    assert(varData[lit2.var()].removed == Elimed::none
            || varData[lit2.var()].removed == Elimed::queued_replacer);
    #endif //DEBUG_ATTACH
...
void PropEngine::attachClause(
    ...
    for (uint32_t i = 0; i < c.size(); i++) {
        assert(varData[c[i].var()].removed == Elimed::none
                || varData[c[i].var()].removed == Elimed::queued_replacer);
    }
    #endif //DEBUG_ATTACH
