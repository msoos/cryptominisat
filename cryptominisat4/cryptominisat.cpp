...
void update_config(SolverConf& conf, unsigned thread_num)
{
    switch(thread_num) {
        ...
        case 4: {
            ...
            conf.ratio_keep_clauses[clean_to_int(ClauseCleaningTypes::clean_glue_based)] = 0;
            conf.ratio_keep_clauses[clean_to_int(ClauseCleaningTypes::clean_size_based)] = 0;
            conf.ratio_keep_clauses[clean_to_int(ClauseCleaningTypes::clean_sum_activity_based)] = 0.5;
            break;
        }
        case 5: {
